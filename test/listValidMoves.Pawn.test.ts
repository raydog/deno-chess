...
Deno.test("List Valid Moves > Pawn > White opening", function () {
  const b = boardLayout({
    c2: encodePieceSpace(PieceType.Pawn, COLOR_WHITE),
  });
...
Deno.test("List Valid Moves > Pawn > Black opening", function () {
  const b = boardLayout({
    f7: encodePieceSpace(PieceType.Pawn, COLOR_BLACK),
  });
...
Deno.test("List Valid Moves > Pawn > White basic move", function () {
  const b = boardLayout({
    d6: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black basic move", function () {
  const b = boardLayout({
    b3: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > White blocked by white", function () {
  const b = boardLayout({
    e4: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
    e5: encodePieceSpace(PieceType.Queen, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > White blocked by black", function () {
  const b = boardLayout({
    e4: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
    e5: encodePieceSpace(PieceType.Knight, COLOR_BLACK, true),
  });
  assertMoves(b, listValidMoves(b, coordFromAN("e4")), []);
});
...
Deno.test("List Valid Moves > Pawn > Black blocked by white", function () {
  const b = boardLayout({
    b3: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
    b2: encodePieceSpace(PieceType.Queen, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black blocked by black", function () {
  const b = boardLayout({
    b3: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
    b2: encodePieceSpace(PieceType.Queen, COLOR_BLACK, true),
  });
  assertMoves(b, listValidMoves(b, coordFromAN("b3")), []);
});
...
Deno.test("List Valid Moves > Pawn > Black promotion", function () {
  const b = boardLayout({
    e2: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > White capture promotion", function () {
  const b = boardLayout({
    c7: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
    d8: encodePieceSpace(PieceType.Queen, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black capture promotion", function () {
  const b = boardLayout({
    e2: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
    f1: encodePieceSpace(PieceType.Queen, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > White opening capture left", function () {
  const b = boardLayout({
    h2: encodePieceSpace(PieceType.Pawn, COLOR_WHITE),
    g3: encodePieceSpace(PieceType.Bishop, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > White opening capture right", function () {
  const b = boardLayout({
    a2: encodePieceSpace(PieceType.Pawn, COLOR_WHITE),
    b3: encodePieceSpace(PieceType.Rook, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black opening capture left", function () {
  const b = boardLayout({
    ...
    g6: encodePieceSpace(PieceType.Rook, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black opening capture right", function () {
  const b = boardLayout({
    ...
    b6: encodePieceSpace(PieceType.Rook, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black opening capture both", function () {
  const b = boardLayout({
    c7: encodePieceSpace(PieceType.Pawn, COLOR_BLACK),
    b6: encodePieceSpace(PieceType.Rook, COLOR_WHITE, true),
    d6: encodePieceSpace(PieceType.Rook, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > White captures en passant on the left", function () {
  const b = boardLayout({
    e5: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
...
Deno.test("List Valid Moves > Pawn > White captures en passant on the right", function () {
  const b = boardLayout({
    e5: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
    f5: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black captures en passant on the left", function () {
  const b = boardLayout({
    ...
    d4: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
  });
...
Deno.test("List Valid Moves > Pawn > Black captures en passant on the right", function () {
  const b = boardLayout({
    e4: encodePieceSpace(PieceType.Pawn, COLOR_BLACK, true),
    f4: encodePieceSpace(PieceType.Pawn, COLOR_WHITE, true),
  });

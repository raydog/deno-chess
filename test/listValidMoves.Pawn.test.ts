...
Deno.test("List Valid Moves > Pawn > White opening", function () {
  ...
  b.set(idx, encodePieceSpace(PieceType.Pawn, Color.White, false, false));
...
Deno.test("List Valid Moves > Pawn > Black opening", function () {
  ...
  b.set(idx, encodePieceSpace(PieceType.Pawn, Color.Black, false, false));
...
Deno.test("List Valid Moves > Pawn > White basic move", function () {
  ...
  b.set(idx, encodePieceSpace(PieceType.Pawn, Color.White, true, true));
...
Deno.test("List Valid Moves > Pawn > Black basic move", function () {
  ...
  b.set(idx, encodePieceSpace(PieceType.Pawn, Color.Black, true, true));
...
Deno.test("List Valid Moves > Pawn > White blocked by white", function () {
  ...
  b.set(
    coordFromAN("e5"),
    encodePieceSpace(PieceType.Queen, Color.White, true, true),
  );
...
Deno.test("List Valid Moves > Pawn > White blocked by black", function () {
  ...
  b.set(
    coordFromAN("e5"),
    encodePieceSpace(PieceType.Knight, Color.Black, true, true),
  );
  assertMoves(b, listValidMoves(b, idx), []);
});
...
Deno.test("List Valid Moves > Pawn > White opening capture left", function () {
  ...
  b.set(
    coordFromAN("g3"),
    encodePieceSpace(PieceType.Bishop, Color.Black, true, true),
  );
...
Deno.test("List Valid Moves > Pawn > White opening capture right", function () {
  ...
  b.set(
    coordFromAN("b3"),
    encodePieceSpace(PieceType.Rook, Color.Black, true, true),
  );
...
Deno.test("List Valid Moves > Pawn > Black opening capture left", function () {
  ...
  b.set(
    coordFromAN("g6"),
    encodePieceSpace(PieceType.Bishop, Color.White, true, true),
  );
...
Deno.test("List Valid Moves > Pawn > Black opening capture right", function () {
  ...
  b.set(
    coordFromAN("b6"),
    encodePieceSpace(PieceType.Rook, Color.White, true, true),
  );
...
Deno.test("List Valid Moves > Pawn > White middle captures in filled board", function () {
  const b = new Board();
  boardFill(b, encodePieceSpace(PieceType.Queen, Color.Black, true, true));
...
Deno.test("List Valid Moves > Pawn > Black middle captures in filled board", function () {
  const b = new Board();
  boardFill(b, encodePieceSpace(PieceType.Queen, Color.White, true, true));
  const idx = coordFromAN("c4");
  b.set(idx, encodePieceSpace(PieceType.Pawn, Color.Black, true, true));

...
import { PIECETYPE_BISHOP, PIECETYPE_KNIGHT, PIECETYPE_QUEEN, PIECETYPE_ROOK } from "../datatypes/PieceType.ts";
import { listAllValidMoves } from "./listValidMoves.ts";
import { performMove } from "./performMove.ts";

const PROMOTIONS = [ PIECETYPE_BISHOP, PIECETYPE_ROOK, PIECETYPE_KNIGHT, PIECETYPE_QUEEN ];

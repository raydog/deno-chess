 ...
 * @returns 
 */
export function buildCastleMap(whiteQRook: Coord, whiteKRook: Coord, blackQRook: Coord, blackKRook: Coord): CastleMap {
  return (whiteKRook & 0xf) | (whiteQRook & 0xf) << 4 | (blackKRook & 0xf) << 8 | (blackQRook & 0xf) << 12;
}
 ...
 */
export function castleMapGetFile(map: CastleMap, color: Color, kingSide: boolean): CastleMap {
